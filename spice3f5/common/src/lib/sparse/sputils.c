...
/* Same as above, but strips entire matrix without destroying the frame.
 * This assumes that the matrix will be replaced with one of the same size.
 */
void
