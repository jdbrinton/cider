...
double limitResistorVoltage( vnew, vold, icheck )
double vnew, vold;
int *icheck;
{
    double vlim, vinc;
...
double limitJunctionVoltage( vnew, vold, icheck )
double vnew, vold;
int *icheck;
{
    double vlim, vinc;
...
double limitVbe( vnew, vold, icheck )
double vnew, vold;
int *icheck;
{
    double vlim, vinc;
...
double limitVce( vnew, vold, icheck )
double vnew, vold;
int *icheck;
{
    double vlim;
...
double limitVgb( vnew, vold, icheck )
double vnew, vold;
int *icheck;
{
    double vlim;
