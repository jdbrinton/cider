...
BOOLEAN BandGapNarrowing;
BOOLEAN TempDepMobility, ConcDepMobility, FieldDepMobility, TransDepMobility;
BOOLEAN SurfaceMobility, MatchingMobility, MobDeriv;
BOOLEAN CCScattering;
BOOLEAN Srh, Auger, ConcDepLifetime, AvalancheGen;
BOOLEAN FreezeOut = FALSE;
BOOLEAN OneCarrier;
 ...
 */
void GLOBcomputeGlobals( pGlobals, temp )
...
void GLOBputGlobals( values )
GLOBvalues *values;
{
  if ( values IS NIL(GLOBvalues) ) {
...
void GLOBprnGlobals( file, values )
FILE *file;
GLOBvalues *values;
{
