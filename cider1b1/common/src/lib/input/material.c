...
#ifdef __STDC__
extern int MATLnewCard(GENERIC**,GENERIC*);
extern int MATLparam(int,IFvalue*,GENERIC*);
#else
extern int MATLnewCard();
extern int MATLparam();
#endif /* STDC */
