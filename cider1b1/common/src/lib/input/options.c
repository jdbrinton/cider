...
#ifdef __STDC__
extern int OPTNnewCard(GENERIC**,GENERIC*);
extern int OPTNparam(int,IFvalue*,GENERIC*);
#else
extern int OPTNnewCard();
extern int OPTNparam();
#endif /* STDC */
