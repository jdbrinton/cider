...
#ifdef __STDC__
extern int MODLnewCard(GENERIC**,GENERIC*);
extern int MODLparam(int,IFvalue*,GENERIC*);
#else
extern int MODLnewCard();
extern int MODLparam();
#endif /* STDC */
