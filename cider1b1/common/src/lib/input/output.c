...
#ifdef __STDC__
extern int OUTPnewCard(GENERIC**,GENERIC*);
extern int OUTPparam(int,IFvalue*,GENERIC*);
#else
extern int OUTPnewCard();
extern int OUTPparam();
#endif /* STDC */
