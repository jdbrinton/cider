...
void NUMD2update( pDevice, delV, updateBoundary )
     TWOdevice *pDevice;
     double delV;
...
void NBJT2update( pDevice, delVce, delVbe, updateBoundary )
     TWOdevice *pDevice;
     double delVce, delVbe;
     BOOLEAN updateBoundary;
{
...
void NUMOSupdate( pDevice, delVdb, delVsb, delVgb, updateBoundary )
     TWOdevice *pDevice;
     double delVdb, delVsb, delVgb;
     BOOLEAN updateBoundary;
{
...
void storeNewRhs( pDevice, pContact )
     TWOdevice *pDevice;
     TWOcontact *pContact;
{
