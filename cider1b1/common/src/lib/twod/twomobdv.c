...
void
  TWO_mobDeriv( pElem, chanType, ds )
...
double ds;			/* normalized hgt (len) of interface element */
{
  ...
  double coeffHx, coeffHy, coeffHs;
  double coeffVx, coeffVy, coeffVs;
  double dFnxDMun, dFnyDMun, dFnDEs;
  double dFpxDMup, dFpyDMup, dFpDEs;
...
void
  TWONmobDeriv( pElem, chanType, ds )
TWOelem *pElem;			/* channel or bulk element */
int chanType;			/* flag for direction of channel */
double ds;			/* normalized hgt (len) of interface element */
{
...
void
  TWOPmobDeriv( pElem, chanType, ds )
TWOelem *pElem;			/* channel or bulk element */
int chanType;			/* flag for direction of channel */
double ds;			/* normalized hgt (len) of interface element */
{
