...
void MOBsurfElec( info, pElem, ex, ey, es, wx, wy, totalConc )
TWOmaterial *info; 
TWOelem *pElem;
double ex, ey, es, wx, wy, totalConc;
{
...
void MOBsurfHole( info, pElem, ex, ey, es, wx, wy, totalConc )
TWOmaterial *info; 
TWOelem *pElem;
double ex, ey, es, wx, wy, totalConc;
{
