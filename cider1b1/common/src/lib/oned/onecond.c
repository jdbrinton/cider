...
void
NUMDconductance(pDevice, tranAnalysis, intCoeff, gd)
  ONEdevice *pDevice;
...
void
NBJTconductance(pDevice, tranAnalysis, intCoeff,
...
void
NUMDcurrent(pDevice, tranAnalysis, intCoeff, id)
  ONEdevice *pDevice;
  BOOLEAN tranAnalysis;
  double *intCoeff;
  double *id;
...
void
NBJTcurrent(pDevice, tranAnalysis, intCoeff, ie, ic)
  ONEdevice *pDevice;
  BOOLEAN tranAnalysis;
  double *intCoeff;
  double *ie, *ic;
